<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingUp.aspx.cs" Inherits="Myproject.SingUp" %>
    ...
    <form id="form1" runat="server">
        <div>
                ...
                <div class="container">
                    ...
                    <div class ="navbar-collapse collapsed">
                        <ul class ="nav navbar-nav nav navbar-right">
                            ...
                            <li ><a href="SingIn.aspx">SIGNIN<asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
                                </a> &nbsp;</li>
            ...
            <div class="center-page">
                ...
                <div class="col-xs-11">
                <asp:TextBox ID="TextUserName" runat="server" class="form-control" placeholder="Enter Your Name"></asp:TextBox>
                    </div>
                ...
                <div class="col-xs-11">
                <asp:TextBox ID="Textpss2" runat="server" class="form-control" placeholder="Enter Your Confirm Password"></asp:TextBox>
                    </div>
                <label class="col-xs-11">Country:</label>

                <div class="col-xs-11">
                <asp:TextBox ID="TextCon" runat="server" class="form-control" placeholder="Enter Your Country"></asp:TextBox>
                    </div>
                
                 <label class="col-xs-11"></label>
                <div class="col-xs-11">
                    <asp:Button ID="Buttonsignup" Class="btn btn-success" runat="server" Text="SignUp" />
